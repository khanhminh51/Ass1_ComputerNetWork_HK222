...
class Client:
    ...
    def createWidgets(self):
        ...
        # Create Play button
        self.start = Button(self.master, width=20, padx=3,
                            pady=3, bg="#4da6ff", fg="white", font=("Arial", 11, "bold"))
        self.start["text"] = "PLAY"
        self.start["command"] = self.playMovie
        self.start.grid(row=1, column=1, padx=2, pady=2)

        # Create Pause button
        self.pause = Button(self.master, width=20, padx=3,
                            pady=3, bg="#4da6ff", fg="white", font=("Arial", 11, "bold"))
        ...
        self.gofoward = Button(self.master, width=20,
                               padx=3, pady=3, bg="#4da6ff", fg="white", font=("Arial", 11, "bold"))
        ...
        self.gobackward = Button(
            self.master, width=20, padx=3, pady=3, bg="#4da6ff", fg="white", font=("Arial", 11, "bold"))
        ...
        self.teardown = Button(self.master, width=20,
                               padx=3, pady=3, bg="#4da6ff", fg="white", font=("Arial", 11, "bold"))
        ...
        self.describe = Button(self.master, width=20,
                               padx=3, pady=3, bg="#4da6ff", fg="white", font=("Arial", 11, "bold"))
        ...
        self.label = Label(self.master, height=21,
                           background="#99ffd6", justify="center")
        self.label.grid(row=0, column=0, columnspan=8,
                        sticky=W+E+N+S, padx=5, pady=5)
        # self.label.place(width="50px", height="50px")
    ...
    def setClientStat(self):
        ...
        self.playTimeStat = Label(self.master, width=30, padx=3, pady=3)
        self.playTimeStat["text"] = "Playing time : " + \
            str(format(self.playingTime, '.2f')) + " seconds"
        self.playTimeStat.grid(row=2, column=3, padx=2, pady=2)

        # Crate FPS lable
        self.videoTimeStat = Label(self.master, width=30, padx=3, pady=3)
        self.videoTimeStat["text"] = "Video's Time : " + \
            str(format(self.frameNbr / 20, '.2f')) + " seconds"
    ...
    def goFoward(self):
        if self.framePause == True:
            ...
            self.label.configure(image=photo, height=388)
